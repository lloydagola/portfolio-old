    ...
    <div class="max-w-7xl border-l border-r border-dashed border-gray-700 mx-auto px-4">
      <div class="pt-5 pb-12 md:flex md:items-center md:justify-between">
        ...
        <p class="mt-8 text-sm leading-6 text-gray-400 md:mt-0 md:order-1">
          {{ $config.name }} •about <span class="ceator-preview hover:text-hot-pink text-gray-300">
          <a class="hidden md:inline-block" rel="noreferrer" target="_blank" href="https://github.com/lloydagola">
          <creator-preview
            :avatar="avatar"
            :name="name"
          ...
          <a class="inline-block md:hidden" target="_blank" href="https://github.com/lloydagola">{{ name }} </a>
          </span>
        </p>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      avatar: 'https://avatars.githubusercontent.com/u/31162324?v=4',
      name: 'Lloyd',
      mode: 'dark',
      description: 'Software Engineer and tinkerer.',
      content: `Hey, I am Lloyd 👋<br/><br/>
